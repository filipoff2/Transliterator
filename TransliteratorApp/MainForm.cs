...
namespace TransliteratorApp
{
    public partial class MainForm : Form
    {
        ...
        {
            {"sz", "ш"},{"cz", "ч"},{"dz", "дз"},{"dź", "дь"},{"rz", "ж"},{"ja", "Я"},{"ju", "Ю"},{"ia", "Я"},{"je", "Е"},{"ie", "Е"},{"e", "Э"},{"a", "а"},{"b", "б"},{"c", "ц"},{"ć", "ч"},{"d", "д"},{"f", "ф"},{"g", "г"},{"ch", "х"},{"h", "х"},{"i", "и"},{"j", "й"},{"k", "к"},{"l", "л"},{"ł", "л"},{"m", "м"},{"n", "н"},{"ń", "нь"},{"o", "о"},{"p", "п"},{"r", "р"},{"s", "с"},{"t", "т"},{"u", "у"},{"w", "в"},{"y", "ы"},{"z", "з"},{"ź", "зь"},{"ż", "ж"}
        };

        private Dictionary<string, string> cyrToPl = new Dictionary<string, string>
        {
            {"ш", "sz"},{"ч", "ć"},{"дз", "dz"},{"дь", "dź"},{"ж", "ż"},{"Я", "ja"},{"Ю","ju"},{"Е", "je"},{"Э", "e"},{"а", "a"},{"б", "b"},{"ц", "c"},{"д", "d"},{"ф", "f"},{"г", "g"},{"х", "h"},{"и", "i"},{"й", "j"},{"к", "k"},{"л", "l"},{"м", "m"},{"н", "n"},{"нь", "ń"},{"о", "o"},{"п", "p"},{"р", "r"},{"с", "s"},{"т", "t"},{"у", "u"},{"в", "w"},{"ы", "y"},{"з", "z"},{"зь", "ź"}
        };
